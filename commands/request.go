...
func HandleRequest(request string) {
	...
	prompt := `You are an AI assistant in a CLI tool. Analyze the provided project structure and file contents, then suggest responses for provided request. Format your response as follows:
